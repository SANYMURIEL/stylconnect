        ...
        <div className="max-h-[275px] overflow-y-auto custom-scrollbar">
          <table className="min-w-full table-auto">
            <thead className="bg-pink-50 border-b border-pink-100 text-gray-700 sticky top-0 z-10">
              <tr>
                <th className="text-center text-sm font-semibold text-pink-500 px-6 py-4"> {/* MODIFIÉ : text-center */}
                  Nom
                </th>
                <th className="text-center text-sm font-semibold text-pink-500 px-6 py-4"> {/* MODIFIÉ : text-center */}
                  Email
            ...
            <tbody>
              {filteredUsers.map((user, index) => (
                ...
                >
                  <td className="px-6 py-4 text-sm text-center"> {/* MODIFIÉ : text-center */}
                    {user.name}
                  </td>
                  <td className="px-6 py-4 text-sm text-center"> {/* MODIFIÉ : text-center */}
                    {user.email}
                  </td>
                  <td className="px-6 py-4 text-center"> {/* MODIFIÉ : text-center */}
                    <span

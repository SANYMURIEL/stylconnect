// app/api/recruteur/profile/route.ts
...
export const GET = async () => {
  try {
    ...
    // Vérifier si l'utilisateur est authentifié et a le rôle 'recruteur'
    ...
    return new NextResponse(JSON.stringify({ message: "Failed to fetch recruiter profile" }), { status: 500 });
  }
};